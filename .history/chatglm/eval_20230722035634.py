...
# LORA_WEIGHTS=find_latest_folder(LORA_WEIGHTS)


# def eval(LORA_WEIGHTS):
...
check_points=[str(int(2000*float(percentage))),str(int(4000*float(percentage)))
              ,str(int(6000*float(percentage))),str(int(8000*float(percentage))),str(int(12000*float(percentage)))
              ]
# check_points=[str(int(400*float(percentage))),str(int(1200*float(percentage)))
#               ,str(int(2000*float(percentage))),str(int(2800*float(percentage))),str(int(3600*float(percentage))),str(int(4000*float(percentage)))
#             #   ,str(int(6000*float(percentage))),str(int(8000*float(percentage))),str(int(12000*float(percentage)))
#               ]
...
# eval(str(int(12000*float(percentage))),is_validation=False)
