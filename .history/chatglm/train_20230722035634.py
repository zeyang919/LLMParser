...
# parser.add_argument("--output_dir", type=str, default="chatglm6b-dddd")
...
output_dir = "./trained/{}/{}/".format(project, train_percentage)
pretrainedmodel_path = "./{}/".format(args.model)
