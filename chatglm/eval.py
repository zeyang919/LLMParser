...
parser.add_argument("--base_model", type=str, default="../LLMs/chatglm6b-dddd")
...
LORA_WEIGHTS = "../fine_tuned_model/chatglm/" + project + "/" + percentage+"/"
max_length=1024
...
def eval(check_point,is_validation=False):
    ...
    if not is_validation:
        output_dir = "../output/chatglm/" + project + "/" + percentage + "/"
    else:
        output_dir = "../output/chatglm/" + project + "/" + percentage + "/validation_"+check_point+"/"
